// WebSocket handlers for DeFi - Real-time updates and notifications
...
const setupWebSocketHandlers = (ws) => {
  ...
  ws.send(JSON.stringify({
    type: 'connection',
    message: 'Connected to DeFi WebSocket server',
  ...
  const mockNotifications = [
    {
      ...
      message: 'You earned 150 DeFi tokens from Crypto Warriors!',
      timestamp: new Date().toISOString(),
      read: false
    },
    {
      ...
      message: 'DeFi-ETH pool now offers 48.5% APY!',
      timestamp: new Date().toISOString(),
      read: false
    }
  ];
