...
router.get('/overview', (req, res) => {
  try {
    ...
    const overview = {
      ...
      tokenomics: {
        DeFiPrice: marketData.DeFiPrice,
        DeFiMarketCap: marketData.DeFiMarketCap,
        DeFiCirculatingSupply: marketData.DeFiCirculatingSupply,
        DeFiTotalSupply: marketData.DeFiTotalSupply,
        priceChange24h: 5.2,
        priceChange7d: 12.8,
        priceChange30d: -3.5
      },
...
router.get('/market-data', (req, res) => {
  try {
    ...
    const realTimeData = {
      timestamp: new Date().toISOString(),
      DeFi: {
        price: marketData.DeFiPrice + (Math.random() - 0.5) * 0.1,
        change24h: 5.2,
        volume24h: 2500000,
        marketCap: marketData.DeFiMarketCap,
        circulatingSupply: marketData.DeFuCirculatingSupply
      },
      topTokens: [
        { symbol: 'DeFi', price: 0.85, change24h: 5.2, volume: 2500000 },
      ...
      trending: [
        { symbol: 'DeFi', volume: 2500000, change: 5.2 },
